...
const Content: React.FC<{ joke: Joke, meme: Meme, reload: any }> = ({ joke, meme, reload }) => {
            ...
            <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
                ...
                <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
                    <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
                        ...
                        <blockquote className="leading-8 font-acmes font-acme text-gray-900 sm:text-[35px] sm:leading-9">
                            {isShow ? <p>
                                "{joke.setup}"
                    ...
                    <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
                        <img
                            className="rounded-xl bg-indigo-50 lg:rounded-3xl shadow-xl"
                            src={meme.urls.thumb}
                            alt=""
                        />
                    </div>
                    <figcaption className="text-base lg:col-start-1 lg:row-start-3">
                        <div className="font-poppin font-poppins text-gray-900 uppercase">{joke.type} JOKES</div>
                        <div className="mt-1 text-gray-500 font-poppins font-acmes">Software Developer</div>
                        <div className='mt-2 flex space-x-4'>
                            ...
                            <div>
                                <button onClick={reload}
                                    type="button"
                                    className="rounded-md font-poppins font-acmes bg-indigo-50 px-3.5 py-2.5 text-sm text-indigo-600 shadow-sm hover:bg-indigo-100"
                                >
                                    Next Joke
                                </button>
                            </div>
